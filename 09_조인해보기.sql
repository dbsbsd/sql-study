...
ON e.department_id = d.deaprtment_id; -- ASNI 표준 조인 문법
...
AND loc.state_provice = 'California'; -- 1
...
4. 위에 결과와 jobs 테이블을 조인하고 최종 결과를 출력.
*/
...
WHERE e.department_id = d.department_id(+) -- 조건식
