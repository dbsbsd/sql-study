...
BEGIN
    ...
    EXCEPTION
        WHEN quantity_shortage_exception THEN
            ...
            -- 첫번째 매개값: 에러 코드 (사용자 정의 예외 -20,000 ~ -20,999)
            -- 두번째 매개값: 에러 메세지
            RAISE_APPLICATION_ERROR(-20001, '주문하신 수량보다 재고가 적습니다.');
        WHEN zero_total_exception THEN
            RAISE_APPLICATION_ERROR(-20002, '주문하신 상품의 재고가 없습니다.');
END;
...
-- 에러 20,001
INSERT INTO order_history VALUES(order_history_seq.NEXTVAL, 201, 3, 6, 30000);
...
-- 에러 20,002
INSERT INTO order_history VALUES(order_history_seq.NEXTVAL, 203, 3, 1, 5000);
